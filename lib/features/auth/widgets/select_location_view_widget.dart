...
class _SelectLocationViewWidgetState extends State<SelectLocationViewWidget> {
  ...
  void initState() {
    ...
    // Keep the default location initially
    ...
    // Then try to get the current device location
    _setCurrentLocation();
  }
  ...
  Future<void> _setCurrentLocation() async {
    ...
    Get.find<LocationController>().setLocation(_cameraPosition.target);

    if (_mapController != null) {
      _mapController!.moveCamera(CameraUpdate.newCameraPosition(_cameraPosition));
    }
