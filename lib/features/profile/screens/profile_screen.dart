          ...
          mainWidget: SingleChildScrollView(physics: const BouncingScrollPhysics(), child: Center(child: Container(
            ...
            child: Column(children: [
              ...
              Row(children: [
                ...
                SizedBox(width: Get.find<ProfileController>().modulePermission!.regularOrder! && _isOwner ? Dimensions.paddingSizeSmall : 0),
                Get.find<ProfileController>().modulePermission!.regularOrder! ? ProfileCardWidget(title: 'total_order'.tr, data: profileController.profileModel!.orderCount.toString()) : const SizedBox(),
              ]),
              const SizedBox(height: 30),
