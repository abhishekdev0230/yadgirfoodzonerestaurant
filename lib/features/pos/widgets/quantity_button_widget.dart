    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(width: 1, color: isIncrement ? Theme.of(context).primaryColor : Theme.of(context).hintColor),
        ...
        child: Icon(
          ...
          size: 15,
          color: isIncrement ? Theme.of(context).cardColor : Theme.of(context).hintColor,
        ),
      ),
    );
  }
